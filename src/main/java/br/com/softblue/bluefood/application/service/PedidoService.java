...
public class PedidoService {
	...
	public Pedido criarEPagar(Carrinho carrinho, String numCartao ) throws PagamentoException {
		...
		/**
		 * ItemPedido não tem ID gerado Automaticamente
		 * 		Ele tem um ID que é uma chave primária composta
		...
		//Instância de envio via http de dados para o servidor
		HttpEntity<DadosCartao> requestEntity = new HttpEntity<DadosCartao>(dadosCartao, headers);
		
		//Objeto para fazer invocação de webservice
